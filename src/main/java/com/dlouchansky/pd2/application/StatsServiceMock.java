...
public class StatsServiceMock implements StatsService {
    ...
    public List<TopPlayerDTO> getForTopPlayers() {
        ...
        result.add(new TopPlayerDTO(1, "player 1", "team 1", 5, 2, 5, 5, "0:01", 5, 5, 5));
        result.add(new TopPlayerDTO(2, "player 2", "team 2", 4, 1, 5, 5, "0:33", 5, 5, 5));
        result.add(new TopPlayerDTO(3, "player 3", "team 3", 3, 0, 5, 5, "11:11", 5, 5, 5));
        return result;
    }
